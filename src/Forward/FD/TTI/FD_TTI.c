...
/* global variables */
extern int MYID, FDORDER, NX, NY, NT, QUELLTYP, RUN_MULTIPLE_SHOTS, READREC;
extern int LOG, SEISMO, N_STREAMER, FW, NXG, NYG, IENDX, IENDY, SNAP;
extern int WRITE_STF,FREE_SURF,POS[3];
...
/* create model grids */
readmod_elastic_TTI(matTTI.prho,matTTI.c11,matTTI.c13,matTTI.c33,matTTI.c44,matTTI.theta);

/* check if the FD run will be stable and free of numerical dispersion */
checkfd_ssg_VTI(FP,matTTI.prho,matTTI.c11,matTTI.c13,matTTI.c33,matTTI.c44,hc);

/* arithmetic average of density */
av_rho(matTTI.prho,matTTI.prip,matTTI.prjp);

// Jian Cao: An extension of the adaptive free-surface expression in the VTI medium 
if ((FREE_SURF) && (POS[2]==0)){

   fprintf(FP," Attention!!! The shallow part (at least 2 grid layers) should be VTI media, namely theta = 0. \n\n");

   for (i=1; i<=NX; i++)
   {

      matTTI.prip[1][i]=2.*matTTI.prip[1][i];
      matTTI.c11[1][i]=(matTTI.c11[1][i]*matTTI.c33[1][i]-matTTI.c13[1][i]*matTTI.c13[1][i])/(2.*matTTI.c33[1][i]);
      matTTI.c13[1][i]=0.;
      matTTI.c33[1][i]=0.;
...
TTI(&wavePSV,&wavePSV_PML,&matTTI,&mpiPSV,&seisPSV,&acq,hc,ishot,nshots,nsrc_loc,ns,ntr,Ws,Wr,req_send,req_rec);
