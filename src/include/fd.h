...
struct wavePSV{
   ...
   float *** pr, ***pp, ***pq;
   float ** vx_real, ** vx_imag, ** vy_real, ** vy_imag;
} wavePSV; 
...
float **   sxy, float ** eta_x, float ** eta_z, float ** uipjp, float ** absorb_coeff, float **lambda, float *hc, int infoout,
...
void TTI(struct wavePSV *wavePSV, struct wavePSV_PML *wavePSV_PML, struct matTTI *matTTI, struct mpiPSV *mpiPSV, 
         struct seisPSV *seisPSV, struct acq *acq, float *hc, int ishot, int nshots, int nsrc_loc, 
         int ns, int ntr, float **Ws, float **Wr,MPI_Request * req_send, MPI_Request * req_rec);
