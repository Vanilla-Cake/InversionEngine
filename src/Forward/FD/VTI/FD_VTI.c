...
/* create model grids */
readmod_elastic_VTI(matVTI.prho,matVTI.c11,matVTI.c13,matVTI.c33,matVTI.c44);

/* check if the FD run will be stable and free of numerical dispersion */
checkfd_ssg_TTI(FP,matVTI.prho,matVTI.c11,matVTI.c13,matVTI.c33,matVTI.c44,hc);
...
if ((FREE_SURF) && (POS[2]==0)){
   ...
   for (i=1; i<=NX; i++)
   {
      ...
      matVTI.prip[1][i]=2.*matVTI.prip[1][i];
      matVTI.c11[1][i]=(matVTI.c11[1][i]*matVTI.c33[1][i]-matVTI.c13[1][i]*matVTI.c13[1][i])/(2.*matVTI.c33[1][i]);
      matVTI.c13[1][i]=0.;
      matVTI.c33[1][i]=0.;
...
VTI(&wavePSV,&wavePSV_PML,&matVTI,&mpiPSV,&seisPSV,&acq,hc,ishot,nshots,nsrc_loc,ns,ntr,Ws,Wr,req_send,req_rec);
